...
export default class MongoInterface  {
    ...
    async createCollectionUniqueIndexes()
    {
      ...
      await this.createIndexOnCollection('network_pools', 'pool_id') 
      await this.createIndexOnCollection('network_pools', 'address')
      await this.createIndexOnCollection('network_pools', 'lastupdate')
      
      await this.createIndexOnCollection('network_pools_addresses', 'pool_id') 
      await this.createIndexOnCollection('network_pools_addresses', 'address')
